...
import AddFieldComponent from './AddFieldComponent.jsx'
...
const EditProductAdmin = ({fetchProductData, close, data:prop}) => {
    const [data, setdata] = useState({
        ...
        more_details : prop.more_details || "",
    });
  ...
  return (
    <section className='fixed top-0 right-0 left-0 bottom-0 bg-black z-50 bg-opacity-70 p-4'>
     ...
     <section className=''>
        <div className='p-2bg-white shadow-md flex items-center justify-between'>
